...
namespace Utility
{
    ...
    public class Tuple<T1> : IComparable, ITupleInternal, ITuple
    {
        ...
        {
            Tuple<T1> objTuple = obj as Tuple<T1>;
        ...
        {
            return ((ITupleInternal)this).GetHashCode(EqualityComparer<Object>.Default);
        }
    ...
    public class Tuple<T1, T2> : IComparable, ITupleInternal, ITuple
    {
        ...
        public override Boolean Equals(Object obj)
        {
            return _Equals(obj, EqualityComparer<Object>.Default); ;
        }

        Boolean _Equals(Object other, IEqualityComparer comparer)
        {
        ...
        Int32 IComparable.CompareTo(Object obj)
        {
            return _CompareTo(obj, Comparer<Object>.Default);
        }

        Int32 _CompareTo(Object other, IComparer comparer)
        {
            ...
            if (objTuple == null)
            {
                throw new ArgumentException(string.Format("Wrong type {0} of {1}", this.GetType().ToString()), "other");
            }
        ...
        public override int GetHashCode()
        {
            return _GetHashCode(EqualityComparer<Object>.Default);
        }

        Int32 _GetHashCode(IEqualityComparer comparer)
        {
    ...
    public class Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IComparable, ITupleInternal, ITuple
    {
        ...
        public Tuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, TRest rest)
        {
            ...
            {
                throw new ArgumentException("Last argument is not tuple");
            }
